...
\acknowledgements
Desidero esprimere la mia gratitudine al Professor Ivan Scagnetto, per la disponibilità, la guida e la chiarezza con cui ha saputo orientare il lavoro durante tutto il percorso di ricerca e sviluppo del progetto. La sua competenza e il suo costante supporto hanno rappresentato un riferimento fondamentale durante la realizzazione di questa tesi.

Un sentito ringraziamento va anche al Dottor Luca Miceli, per i preziosi feedback ricevuti durante le fasi di test, per aver fornito sempre un confronto puntuale e costruttivo, contribuendo in modo significativo alla qualità del progetto e mettendo altresì a disposizione tutte le componenti necessarie.

Ringrazio inoltre la Dottoressa Giulia Bongiorno per l’attenzione e la disponibilità con cui ha reso possibile lo svolgimento dei test necessari. I suoi studi, che ho avuto modo di citare all’interno della tesi, hanno rappresentato un importante punto di riferimento teorico e hanno arricchito in modo sostanziale il quadro concettuale della ricerca.
...
\begin{itemize}
  ...
  \item Bongiorno Index (BI): il Bongiorno index medio del neofita è del 15\% a destra e del 20\% a sinistra. L'atleta professionista ha registrato valori dell'80\% a sinistra e di 70\% a destra.
  \begin{figure}[H]
    \centering
