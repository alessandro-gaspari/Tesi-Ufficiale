...
var bpmSamples = [];
\end{lstlisting}
Uno dei compiti più importanti delegati al file JavaScript è la trasformazione dei valori dei sensori in angoli per le tibie e per il ginocchio. Il calcolo più semplice dei due è quello relativo alle tibie, calcolato tramite il singolo sensore posto sull'esterno della caviglia. Una volta che i dati giungeranno alla dashboard, per evitare sovraccarichi inutili a livello dell'applcazione mobile, verrà applicata la funzione arcotangente alle componenti $y$ e $z$ dell'accelerometro.
