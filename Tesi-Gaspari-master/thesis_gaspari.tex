...
\begin{lstlisting}[language=dart, caption={Connessione al sensore BLE e registrazione del listener di stato.}, label={provider_connect}]
...
\begin{lstlisting}[language=dart, caption={Procedura asincrona per la disconnessione di tutti i sensori.}, label={provider_disconnect_all}]
...
\begin{lstlisting}[language=dart, caption={Definizione del modello dati UserProfile e logica di serializzazione JSON.}, label={profile_model}]
class UserProfile {
  final String id;
  String name;
  int age;
