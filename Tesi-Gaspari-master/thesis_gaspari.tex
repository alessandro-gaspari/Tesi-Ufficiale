...
Qui elencati si possono trovare alcuni casi di studi che coprono tutte le possibilità di utilizzo del sistema:
\begin{enumerate}
    \item Atleta durante l'allenamento: l'atleta si prepara per il monitoraggio accendendo i sensori uno ad uno, verificandone il corretto funzionamento tramite l'accensione di un led. Prosegue indossando uno ad uno tutti i sensori tramite le apposite fasce o sostegni. Successivamente, avvia l'applicazione, seleziona il suo profilo personalizzato precedentemente creato e si connette a tutti i sensori accesi, verificando l'avvenuto abbinamento tramite il cambio di colore del led. Nel caso in cui un determinato sensore sia invertito (per esempio un sensore solitamente indossato a sinistra viene indossato a destra) gli basterà modificare il nome del sensore, senza doverselo togliere e rimettere. Una volta accesi, indossati e connessi i sensori, l'atleta procede a premere il tasto per l'avvio del tracking, potendo poi comodamente mantenere il telefono a schermo spento. Una volta conclusa l'attività, l'atleta riaccenderà lo schermo del telefono per premere il tasto di fine tracciamento. In questo modo la registrazione dei dati è avvenuto in modo corretto e il compito dell'atleta è terminato.
    \item Allenatore in analisi post-attività:
\end{enumerate}
