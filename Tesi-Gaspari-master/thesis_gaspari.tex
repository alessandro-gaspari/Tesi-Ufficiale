...
\begin{enumerate}
  ...
  \item In caso di effetiva presenza di profili utente nel database, l'interfaccia si sbloccherà e verrà concesso l'accesso alla schermata base (\textit{MainWrapperScreen}). 
\end{enumerate}
