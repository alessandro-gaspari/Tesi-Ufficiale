...
\begin{enumerate}
  \item Verificare eventuali sbilanciamenti di peso, tramite i grafici delle pressioni plantari, per evidenziare instabilità che se costanti potrebbero portare a infortuni.
  \item Controllare il corretto angolo di flessione del ginocchio per abbassare il baricentro riducendo il carico sulle articolazioni e prevenendo cadute o lesioni.
  \item Evidenziare l'eventuale assenza di parallelismo fra gli angoli di inclinazione delle tibie, indicante valgismo (piegamento interno del ginocchio) o varismo (piegamento esterno del ginocchio) che porterebbero ad una perdita di prestazioni dell'atleta causando anche un rischio maggiore di infortunio dovuto a torsioni dannose.
  \item Analizzare i Bongiorno Index per valutare l'efficienza di ogni pattinata in base a quanto laterale essa sia, facendo risaltare quanta potenziale energia viene persa con una pattinata non ottimale.
\end{enumerate} 


Proposta di eventuali migliorie future....
