...
\end{lstlisting}
Il secondo metodo presente è \textit{sendData} e rappresenta un tassello fondamentale per questo file essendo che verrà invocato per ogni pacchetto ricevuto dai sensori. Per evitare errori ad una frequenza di invocazione così alta, sono stati adottati due accorgimenti:
\begin{enumerate}
