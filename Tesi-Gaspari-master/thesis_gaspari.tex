...
Flutter organizza il complesso del codice dividendolo in più schermate, ognuna delle quali viene collegata alle altre per far sì che ci si possa spostare comodamente tra di esse. La prima schermata che in questo progetto si visualizzerà una volta aperta l'app per la prima volta sarà la \textit{profile screen.dart}, per far si che l'utente possa creare il suo profilo inserendo i suoi dati.
