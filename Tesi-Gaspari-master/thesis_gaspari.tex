...
L'applicazione mobile e la dashboard web sono state testate sul campo durante il tracciamento di una professionista e di un amatore del roller skating. I test si sono tenuti presso lo Skating Club Comina a Pordenone, in una pista all'aperto dedicata per l'appunto al pattinaggio su rotelle. Come prima cosa, a turno, sono stati montati sugli atleti i seguenti sensori:
\begin{itemize}
...
\chapter{Conclusioni e futuri sviluppi} (1-2 pagine)
Nel progetto discusso dalla presente tesi, è stato finalizzato un sistema di monitoraggio che permette l'analisi dei dati raccolti durante attività sportive, nella fattispecie durante il roller skating. I risultati ottenuti in fase successiva all'analisi post-attività hanno permesso di rispondere alla domanda principale posta inizialmente, ovvero se sia possibile prevenire infortuni e migliorare le prestazioni degli atleti tramite l'utilizzo di sensori wearables tracciati da apposite applicazioni. La sostanziosa differenza evidenziata dai grafici presenti nel capitolo \ref{esempi} testimonia infatti quanto un amatore possa migliorare a livello di movimenti e bilanciamenti del peso per ottenere dei risultati migliori avvicinandosi a tempi di percorrenza sempre più simili a quelli di un professionista. 
