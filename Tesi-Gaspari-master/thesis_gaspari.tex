...
bool _isStartingTracking = false; //verifica avvio tracciamento
...
Per quanto riguarda lo stato del GPS, affinchè la lettura di esso sia immediata, è stata implementata un'enumerazione nominata \textit{GpsSignalQuality} (come si vede nel listato \ref{gps_enum}) che assegnerà automaticamente un'icona e un testo in base alla qualità del segnale.

\begin{lstlisting}[language=dart, caption={Enumerazione della qualità del segnale GPS.}, label={gps_enum}]
